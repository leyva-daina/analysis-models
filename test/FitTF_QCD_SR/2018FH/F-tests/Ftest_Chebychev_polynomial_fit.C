...
//void Ftest_Chebychev_polynomial_fit(const float &xmin = 270, const float &xmax = 560, const float &binning = 10) {
//void Ftest_Chebychev_polynomial_fit(const float &xmin = 320, const float &xmax = 800, const float &binning = 10) {
//void Ftest_Chebychev_polynomial_fit(const float &xmin = 370, const float &xmax = 1270, const float &binning = 20) {
void Ftest_Chebychev_polynomial_fit(const float &xmin = 500, const float &xmax = 2000, const float &binning = 50) {
