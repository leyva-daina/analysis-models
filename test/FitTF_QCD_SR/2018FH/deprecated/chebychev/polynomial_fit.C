...
int polynomial_fit(const bool & mc = true, const float & xmin_ = 270, const float & xmax_ = 2000, const float & binning_ = 1, const int & poldegree_ = 1, const std::string & functname_ = "Chebychev", const float & x0_ = 0.)
{
    ...
    RooRealVar pol_pow_d2_c1("pol_pow_d2_c1", "1st deg term 2nd order pol", 5e-3, -1.00, 1.00);
    RooRealVar pol_pow_d2_c2("pol_pow_d2_c2", "2nd deg term 2nd order pol", 7.e-7, -1.00, 1.00);
    
    RooRealVar pol_pow_d3_c1("pol_pow_d3_c1", "1st deg term 3rd order pol", 5e-3, -1.00, 1.00);
    RooRealVar pol_pow_d3_c2("pol_pow_d3_c2", "2nd deg term 3rd order pol", 7.e-7, -1.00, 1.00);
    RooRealVar pol_pow_d3_c3("pol_pow_d3_c3", "3rd deg term 3rd order pol", 7.e-7, -1.00, 1.00);
    ...
    else if(functname_ == "Bernstein")
    {
        ...
        pol = new RooChebychev("chebychev", "Chebychev PDF", x, RooArgList(pol_bern_d2_c1, pol_bern_d2_c2, pol_bern_d2_c3));

        else if (poldegree_ == 3)
        pol = new RooChebychev("chebychev", "Chebychev PDF", x, RooArgList(pol_bern_d3_c1, pol_bern_d3_c2, pol_bern_d3_c3, pol_bern_d3_c4));
    ...
    else if(functname_ == "Power")
    {
        ...
        pol = std::make_unique<analysis::models::RooPolynomialWithShift>("pol", "polynomial", x, RooArgList(pol_pow_d2_c1, pol_pow_d2_c2), x0, 1);

        else if (poldegree_ == 3)
        pol = std::make_unique<analysis::models::RooPolynomialWithShift>("pol", "polynomial", x, RooArgList(pol_pow_d3_c1, pol_pow_d3_c2, pol_pow_d3_c3), x0, 1);
