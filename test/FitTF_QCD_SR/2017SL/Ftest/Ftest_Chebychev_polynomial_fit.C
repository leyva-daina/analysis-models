...
//void Ftest_Chebychev_polynomial_fit(const float &xmin = 120, const float &xmax = 300, const float &binning = 5) {
//void Ftest_Chebychev_polynomial_fit(const float &xmin = 180, const float &xmax = 460, const float &binning = 5) {
void Ftest_Chebychev_polynomial_fit(const float &xmin = 240, const float &xmax = 800, const float &binning = 5) {
